...
module croc_chip import croc_pkg::*; #() (
  ...
  inout wire VSSIO
    ...
    sg13cmos5l_IOPadOut16mA   pad_unused0_o    (.pad(unused0_o), .c2p(1'b0));
    sg13cmos5l_IOPadOut16mA   pad_unused1_o    (.pad(unused1_o), .c2p(1'b0));
    sg13cmos5l_IOPadOut16mA   pad_unused2_o    (.pad(unused2_o), .c2p(1'b0));
    sg13cmos5l_IOPadOut16mA   pad_unused3_o    (.pad(unused3_o), .c2p(1'b0));
