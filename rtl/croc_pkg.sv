...
package croc_pkg;
  ...
  localparam int unsigned SramBankNumWords  = 1024; //per 1024
  ...
  localparam addr_map_rule_t [1:0] CrocAddrMap = '{
    '{ idx: XbarPeriph,  start_addr: 32'h0000_0000, end_addr: 32'h1000_0000 },
    '{ idx: XbarUser,    start_addr: 32'h1000_0000, end_addr: 32'h8000_0000 } // Moved SRAMs to user domain
  ...
  localparam bit [31:0] BootAddr     = 32'h1000_0000; // start of SRAM banks
