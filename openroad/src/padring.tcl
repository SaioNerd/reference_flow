...
place_pad -row IO_WEST -location [expr {$westStart -  8*$westPitch}] "pad_jtag_tck_i"   ; # pin no: 19
place_pad -row IO_WEST -location [expr {$westStart -  9*$westPitch}] "pad_jtag_trst_ni" ; # pin no: 11
